...
public class PerformanceAspect {
    ...
    @Around("execution(* pl.edu.agh.tutorial.performanceTest.InsertPerformanceTest.*(..))")
    public void performTest(ProceedingJoinPoint proceedingJoinPoint) throws Throwable {
        System.out.println("**********************************************");
